...
local function CreateCastBar(unit, dbKey)
    ...
    spellText:SetFont(Castborn:GetBarFont(), math.max(10, cfg.height - 6), "OUTLINE")
    Castborn:RegisterFontString(spellText, math.max(10, cfg.height - 6), "OUTLINE")
    ...
    timeText:SetFont(Castborn:GetBarFont(), math.max(10, cfg.height - 6), "OUTLINE")
    Castborn:RegisterFontString(timeText, math.max(10, cfg.height - 6), "OUTLINE")
